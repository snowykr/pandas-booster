...
from .conftest import (
    _BENCHMARK_PATH as _BENCHMARK_PATH,
)
from .conftest import (
    _loaded_benchmark_module as _loaded_benchmark_module,
)

_REPORTING_PATH = _BENCHMARK_PATH.parent / "reporting.py"
_GENERATE_BENCHMARK_DOCS_PATH = _BENCHMARK_PATH.parent / "generate_docs.py"
