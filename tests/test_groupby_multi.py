...
class TestSortParameter:
    ...
    def test_sort_true_matches_pandas_order(self, large_multi_df):
        ...
        booster_result = large_multi_df.booster.groupby(["k1", "k2"], "val_float", "sum", sort=True)
    ...
    def test_sort_false_values_match_pandas(self, large_multi_df):
        ...
        booster_result = large_multi_df.booster.groupby(
    ...
    def test_sort_false_single_key(self):
        ...
        booster_result = df.booster.groupby("key", "val", "sum", sort=False)
    ...
    def test_sort_true_is_default(self, large_multi_df):
        ...
        result_default = large_multi_df.booster.groupby(["k1", "k2"], "val_float", "sum")
        result_explicit = large_multi_df.booster.groupby(
    ...
    def test_sort_parameter_three_keys(self, large_multi_df):
        ...
        booster_sorted = large_multi_df.booster.groupby(
