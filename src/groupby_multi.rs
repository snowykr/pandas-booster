...
pub fn multi_groupby_sum_f64(
    ...
    radix_groupby_sum_f64(key_slices, values)
...
pub fn multi_groupby_mean_f64(
    ...
    radix_groupby_mean_f64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_min_f64(
    ...
    radix_groupby_min_f64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_max_f64(
    ...
    radix_groupby_max_f64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_sum_i64(
    ...
    radix_groupby_sum_i64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_mean_i64(
    ...
    radix_groupby_mean_i64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_min_i64(
    ...
    radix_groupby_min_i64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_max_i64(
    ...
    radix_groupby_max_i64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_count_f64(
    ...
    radix_groupby_count_f64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
...
pub fn multi_groupby_count_i64(
    ...
    radix_groupby_count_i64(key_slices, values)
        .map_err(|e| pyo3::exceptions::PyValueError::new_err(e))
}
