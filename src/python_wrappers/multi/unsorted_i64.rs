...
#[pyfunction]
pub(crate) fn groupby_multi_sum_i64<'py>(
    py: Python<'py>,
...
#[pyfunction]
pub(crate) fn groupby_multi_mean_i64<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, i64>,
...
#[pyfunction]
pub(crate) fn groupby_multi_var_i64<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, i64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_std_i64<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, i64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_min_i64<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, i64>,
) -> PyResult<MultiGroupByReturnI64<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_max_i64<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, i64>,
) -> PyResult<MultiGroupByReturnI64<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_count_i64<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, i64>,
) -> PyResult<MultiGroupByReturnI64<'py>> {
