...
#[pyfunction]
pub(crate) fn groupby_multi_sum_f64_sorted<'py>(
    py: Python<'py>,
...
#[pyfunction]
pub(crate) fn groupby_multi_mean_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_var_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_std_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_min_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_multi_max_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<MultiGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn profile_groupby_multi_max_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<MultiGroupByProfileReturnF64<'py>> {
    let values_slice = zero_copy::get_slice_f64(&values)?;
    let key_slices: Vec<&[i64]> = key_cols
        .iter()
        .map(|col| zero_copy::get_slice_i64(col))
    ...
    let profiled = py.detach(|| {
        groupby_multi::profile_multi_groupby_max_f64_sorted(&key_slices, values_slice)
    })?;
    let conversion_start = Instant::now();
    let (key_arrays, values_1d) = convert_multi_result_f64(py, profiled.result)?;
...
#[pyfunction]
pub(crate) fn groupby_multi_count_f64_sorted<'py>(
    py: Python<'py>,
    key_cols: Vec<PyReadonlyArray1<'py, i64>>,
    values: PyReadonlyArray1<'py, f64>,
