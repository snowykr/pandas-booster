...
#[pyfunction]
pub(crate) fn groupby_sum_f64_sorted<'py>(
    py: Python<'py>,
...
#[pyfunction]
pub(crate) fn groupby_mean_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_var_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn profile_groupby_var_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
...
#[pyfunction]
pub(crate) fn groupby_std_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn profile_groupby_std_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByProfileReturnF64<'py>> {
...
#[pyfunction]
pub(crate) fn profile_groupby_median_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByProfileReturnF64<'py>> {
    ...
    let profiled = py
        .detach(|| groupby::profile_parallel_groupby_median_f64_sorted(keys_slice, values_slice))?;
    let materialize_start = Instant::now();
    let (keys_1d, values_1d) = convert_single_result_f64(py, profiled.result)?;
    let profile_dict = build_single_profile_dict(
        py,
...
#[pyfunction]
pub(crate) fn groupby_min_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_max_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
) -> PyResult<SingleGroupByReturn<'py>> {
...
#[pyfunction]
pub(crate) fn groupby_count_f64_sorted<'py>(
    py: Python<'py>,
    keys: PyReadonlyArray1<'py, i64>,
    values: PyReadonlyArray1<'py, f64>,
